...
module.exports = function createFolder(directory) {
  ...
  modalContent.classList.add('modal-content'); // Modal Header
  ...
  modalTitle.textContent = 'Nueva Carpeta'; // Modal body
  ...
  modalBody.appendChild(formGroupBody); // Modal Footer
  ...
  btnFooterSend.textContent = 'Crear'; // Create a new Folder

  btnFooterSend.addEventListener('click', function () {
    var data = {
      path: directory,
      name: inputNameFolder.value
    };
    createDirectory(data);
  });
  modalFooter.appendChild(btnFooterClose);
  modalFooter.appendChild(btnFooterSend); // Append child elems in modal
...
},{"../../clean-array":10,"../services":13}],12:[function(require,module,exports){
...
},{"./services":13,"./template":14,"empty-element":3,"page":5,"title":8}],13:[function(require,module,exports){
...
},{"../api-fetch":9,"../end-point":16,"downloadjs":2,"page":5,"sweetalert2":7}],14:[function(require,module,exports){
...
module.exports = function (data) {
  ...
  panelBody.id = 'panel-content'; // Creando la lista de directorios y archivos
  ...
  panelBody.oncontextmenu = function (e) {
    ...
    document.getElementById('rmenu2').style.left = e.clientX + 'px'; // Crear input file
    ...
    fileName.appendChild(inputFileName); // Subir archivos
...
},{"../content":15,"./create-folder":11,"./services":13}],15:[function(require,module,exports){
var page = require('page');
...
module.exports = function drawContent(content, storagePath) {
  ...
  if (content.type === 'directory') {
    ...
    a.id = 'directory';
    a.href = `/cloud${storagePath}${content.name}`; // Menu contextual de cada directorio
    ...
    a.oncontextmenu = function (e) {
      ...
      document.getElementById('rmenu1').style.left = e.clientX + 'px'; // Eliminar directorio
    ...
    span.classList.add('fileStyleList'); // Menu contextual de cada archivo
    ...
    span.oncontextmenu = function (e) {
      ...
      document.getElementById('rmenu3').style.left = e.clientX + 'px'; // Eliminar archivo
...
},{"../cloud/services":13,"page":5}],16:[function(require,module,exports){
...
},{"../clean-array":10}],17:[function(require,module,exports){
...
},{"./cloud":12,"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":4,"page":5}]},{},[17]);
